...
def save_excel():                    # Função para salvar todos os DataFrames em um único arquivo Excel, com respectivas abas
    ...
    with pd.ExcelWriter(f"XLS_Files/Doações_{ano_celebracao}.xlsx", engine='openpyxl') as writer:
...
while instrumentos:
    try:
        ...
        print(f"\t\tN° de ITERAÇÕES para refresh: {Fore.RED}{Style.BRIGHT}{contador_refresh}/250")
